 ...
 * @types: List a of argumentsss
 * @buffer: Buffer array to handle printas
 * @flags:  Calculates active flagsss
 * @width: get widthhh
 * @precision: Precision specificationn
 * @size: Size specifiern
 * Return: Number of chars printed.dd
 */
...
/************************* PRINT NON PRINTABLE *************************/
/**
 * print_non_printable - Prints ascii codes in hexa of non printable charsss
...
/************************* PRINT REVERSE *************************/
/**
 * print_reverse - Prints reverse stringss.
 * @types: List of argumentsss
 * @buffer: Buffer array to handle printt
 * @flags:  Calculates active flagss
 * @width: get widthh
 * @precision: Precision specificationn
 * @size: Size specifierr
 * Return: Numbers of chars printedd
 */
